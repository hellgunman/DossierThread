...
void ChargementImages()
{
  ...
  // Sprites Poneys  
  AjouteSpriteAFondTransparent(TWILIGHT,"./images/ponies/Twilight40.bmp",255,255,255);
  AjouteSpriteAFondTransparent(APPLEJACK,"./images/ponies/AppleJack40.bmp",255,255,255);
  AjouteSpriteAFondTransparent(PINKIEPIE,"./images/ponies/PinkiePie40.bmp",255,255,255);
  AjouteSpriteAFondTransparent(FLUTTERSHY,"./images/ponies/Fluttershy40.bmp",255,255,255);
  AjouteSpriteAFondTransparent(RAINBOWDASH,"./images/ponies/RainbowDash40.bmp",255,255,255);
  AjouteSpriteAFondTransparent(RARITY,"./images/ponies/Rarity40.bmp",255,255,255);
  AjouteSpriteAFondTransparent(DERPY,"./images/ponies/Derpy40.bmp",255,255,255);
